...
class SoundManager:
    def __init__(self):
        self.sounds = {
            "default": "home/sar/SearchlightScannerV4/intial-test/SearchlightScanner-dev/sounds/beep.mp3",
            "powerline": "home/sar/SearchlightScannerV4/intial-test/SearchlightScanner-dev/sounds/Alarm__Missile_Jettison.ogg.mp3"
        }

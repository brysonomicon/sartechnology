...
class SettingsFrame2(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.targets_label = tk.Label(
            self.targets_frame, text="SELECT TARGETS TO DETECT", bg="#7C889C",
        ...
        # Rest of the widgets (operator alerts, segments, etc.)
        ...
        self.operator_toggle_label = tk.Label(
            self.operator_alerts_toggle_frame, text="OPERATOR ALERTS", bg="#7C889C",
            fg="black", font=font_used)
        self.operator_toggle_label.place(x=20, y=40)
        ...
        self.settings1_button = tk.Button(
            ...
            text="SETTINGS 1", bg="#555", fg="white", font=font_used, width=30, height=5)
        ...
        self.settings2_button = tk.Button(
            ...
            text="SETTINGS 2", bg="#24D215", fg="white", font=font_used, width=30, height=5)
        ...
        self.segments_label = tk.Label(
            self.segments_frame, text="CHOOSE AN AMOUNT OF SEGMENTS", bg="#7C889C",
            fg="black", font=font_used)
